...
define(['jquery','underscore', 'backbone','utilities/session',
        'text!subaging/subaging-page/data-info-view.html'],

    function($, _, Backbone, Session, DataInfoViewTemplate) {
        ...
        var DataInfoView = Backbone.View.extend({
            ...
            fillData: function(subViewEl, rangeCollection){
                ...
                //me.$el.html(me.template({collection: me.monthCollection.toJSON()}));
                me.$el.html(me.template({collection: me.rangeCollection}));
                //console.log("DataInfoView RenderContent range collection: " + JSON.stringify(me.rangeCollection));
...
//                $(".data-wrapper").height($(window).height() - 110);
                ...
                //data-wrapper height
                if((rows + 1) * colHeight > $(window).height() - 110){
                    $(".data-wrapper").height($(window).height() - 110);
                }else{
